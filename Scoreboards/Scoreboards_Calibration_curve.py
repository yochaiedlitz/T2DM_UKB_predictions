...
def plot_calibration_curve(df, files_list=None, path=None, nbins=10, splits=3, fig_size=(16, 9), colors_list=None,
    ...
    if plot_hist:
        ax2 = ax1.twinx()
        x = np.arange(0, (nbins_hist + 1) / 10, 0.1)[1:]
...
def build_relevant_scores_df(leg_dict,
                             scores_df_path="/net/mraid08/export/jafar/Yochai/UKBB_Runs/For_article/"
                                            "Imputed_screened/Imputed_screened_CI_Summary.csv"):
...
def main():
    ...
    scores_df_path="/net/mraid08/export/jafar/Yochai/UKBB_Runs/For_article/" \
                   "Revision_runs/results_folder/Revisioned_CI_Summary.csv"
    if run_type=="LR":
        xlim,ylim=(1,1)
        ...
        leg_dict = OrderedDict([("Four blood tests LR", "Four blood tests LR"),
                                ("Anthropometry with WHR LR", "Anthropometry LR"),
        ...
        leg_dict = OrderedDict([("Four blood tests scoreboard LR", "Four blood tests SB"),
    ...
    scores_df=build_relevant_scores_df(leg_dict,scores_df_path=scores_df_path)
    Save_to_folder_path = "/net/mraid08/export/jafar/Yochai/UKBB_Runs/For_article/Revision_runs/figures"
    ...
    for method in ["isotonic"]:#["LR","isotonic","sigmoid"] -LR is not calibrating
        for calib_type,calib_name in [(GaussianNB(),"Naive Bayes")]: #[(GaussianNB(),"Naive Bayes"),(LinearSVC(max_iter=10000),"SVC")]
            ...
            path = "/net/mraid08/export/jafar/Yochai/UKBB_Runs/For_article/Revision_runs/figures/" + \
