...
SORT = False  # Used mostly for debugging to activate the SORT_AUC_APS function
...
Hyp_Param_Dict_A['num_boost_round'] = [10, 50, 100, 250, 500, 1000,2000,4000, 8000]  # 10, 50, 100, 250, 500, 1000,2000,4000, 8000
