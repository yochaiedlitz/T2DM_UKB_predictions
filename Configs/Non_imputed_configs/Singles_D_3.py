...
BASIC_JOB_NAME = ['Diet','Early_Life_Factors','Family_and_Ethnicity','Lifestyle_and_physical_activity'] #'Early_Life_Factors','Family_and_Ethnicity','Lifestyle_and_physical_activity','Medication'
BASIC_PROB_BASED_JOB_NAME = ["Test_" + x for x in BASIC_JOB_NAME]
Sub_Class_array = ["All","All","All","All"]  # "All",, "All"
Job_ID = ["2443-0.0", "2443-0.0", "2443-0.0", "2443-0.0"]
