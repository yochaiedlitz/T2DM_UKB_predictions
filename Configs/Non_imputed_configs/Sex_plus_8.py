...
BASIC_JOB_NAME = ["Sex_plus_8"]
BASIC_PROB_BASED_JOB_NAME = ["RE_" + x +"_GBDT" for x in BASIC_JOB_NAME]
Sub_Class_array = ["All"]  # "All",, "All"
Job_ID = ["2443-0.0"]
RET_FEAT_file_names = BASIC_JOB_NAME

feat_list_folder = "Diabetes_Features_lists/For_article/Specials/"  # Folder where the features lists located
...
Thresh_in_Column = 0#Require that many non-NA values.
Thresh_in_Row = "any" #Require that many non-NA values.
