...
TEST_PATH = "/net/mraid08/export/jafar/UKBioBank/Data/ukb29741_Diabetes_returned_extended_test"
...
BASIC_JOB_NAME = ['Diabetes_all','Age_and_Sex','Anthropometry','Blood_Tests','BP_and_HR']
BASIC_PROB_BASED_JOB_NAME = ["dbg_"+ x for x in BASIC_JOB_NAME]
Sub_Class_array = ["All","All","All","All","All"]  # "All",, "All"
Job_ID = ["2443-0.0","2443-0.0","2443-0.0","2443-0.0","2443-0.0"]
...
CALC_P_SHAP = False  # Whether or not to calculate the SHAP values for the Prob based predictions
SORT_Prob=True
