...
BASIC_JOB_NAME = ["PRS_AnS"]
BASIC_PROB_BASED_JOB_NAME = ["RE_min" + x for x in BASIC_JOB_NAME]
...
# ['PRS_MAGIC_HbA1C', 'PRS_cigs_per_day', 'PRS_MAGIC_Scott_FG', 'PRS_ln_HOMA-IR', 'PRS_MAGIC_Scott_FI',
