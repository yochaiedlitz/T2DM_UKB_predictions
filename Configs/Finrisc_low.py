...
BASIC_JOB_NAME = ['Finrisc']#['Diabetes_all','Age_and_Sex','Anthropometry','Blood_Tests','BP_and_HR']
BASIC_PROB_BASED_JOB_NAME = ["Strat_L20_H38_"+x for x in BASIC_JOB_NAME]
...
CHARAC_SELECTED = {"Age at last visit": "All", "Sex": "All", "Ethnic background": "All",
                   "Type of special diet followed": "All","Maximal_a1c":38,"Minimal_a1c":20}
...
CALC_P_SHAP = True  # Whether or not to calculate the SHAP values for the Prob based predictions
SORT_Prob=True
...
Hyp_Param_Dict_R["colsample_bytree"] = [1]#[0.01,0.05, 0.1, 0.25, 0.5, 0.7, 1]
