...
BASIC_JOB_NAME = ['Antro_neto_whr']#['Diabetes_all','Age_and_Sex','Anthropometry','Blood_Tests','BP_and_HR']
BASIC_PROB_BASED_JOB_NAME = ["Strat_L20_H39_"+x for x in BASIC_JOB_NAME]
