...
BASIC_JOB_NAME = ['A11_minimal']
BASIC_PROB_BASED_JOB_NAME = ["Strat_H38_" + x for x in BASIC_JOB_NAME]
Sub_Class_array = ["All"]  # "All",, "All"
Job_ID = ["2443-0.0"]
RET_FEAT_file_names = BASIC_JOB_NAME

feat_list_folder = "Diabetes_Features_lists/For_article/Specials/non_lab_breakdown/"  # Folder where the features lists located
...
CHARAC_SELECTED = {"Age at last visit": "All", "Sex": "All", "Ethnic background": "All",
                   "Type of special diet followed": "All","Minimal_a1c":38}
