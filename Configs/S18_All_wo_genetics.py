...
BASIC_JOB_NAME = ["All"]
BASIC_PROB_BASED_JOB_NAME = [x + "_No_gen" for x in BASIC_JOB_NAME]
...
PRS_COLS = ['PRS_MAGIC_HbA1C', 'PRS_MAGIC_Scott_FG', 'PRS_ln_HOMA-IR', 'PRS_MAGIC_Scott_FI',
            'PRS_Manning_FI','PRS_Manning_FG', 'PRS_MAGIC_Scott_2hGlu', 'PRS_glucose_iris',
            'PRS_ln_FastingInsulin','PRS_hba1c','PRS_Manning_BMI_ADJ_FG','PRS_HbA1c_MANTRA',
            'PRS_Manning_BMI_ADJ_FI', 'PRS_FastingGlucose']
...
Select_Top_Traits_Gen_arr_names = ['HbA1c_MANTRA', 't2d_mega_meta', "MAGIC_Scott_FG", 'Magic_2hrGlucose',
                                   ...
                                   'Manning_BMI_ADJ_FG','Manning_Fasting_Insulin', 'Manning_BMI_ADJ_FI',
                                   'HBA1C_ISI']  #
# Select_Top_Traits_Gen_arr_names = ['HbA1c_MANTRA', 't2d_mega_meta', "MAGIC_Scott_FG", 'Magic_2hrGlucose',
