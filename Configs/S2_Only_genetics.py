...
TRAIN_PATH=Imputed_TRAIN_TEST_PATH = '/net/mraid08/export/jafar/UKBioBank/Data/ukb29741_Diabetes_returned_extended_Imputed_train_test.csv'
...
BASIC_JOB_NAME = ["Only_genetics"]
BASIC_PROB_BASED_JOB_NAME = [x for x in BASIC_JOB_NAME]
...
PRS_COLS = ['PRS_MAGIC_HbA1C', 'PRS_MAGIC_Scott_FG', 'PRS_ln_HOMA-IR', 'PRS_MAGIC_Scott_FI',
            'PRS_Manning_FI',
            'PRS_Manning_FG', 'PRS_MAGIC_Scott_2hGlu', 'PRS_glucose_iris', 'PRS_ln_FastingInsulin',
            'PRS_hba1c','PRS_Manning_BMI_ADJ_FG','PRS_HbA1c_MANTRA','PRS_Manning_BMI_ADJ_FI', 'PRS_FastingGlucose']
...
Select_Top_Traits_Gen_arr_names = ['HbA1c_MANTRA', 't2d_mega_meta', "MAGIC_Scott_FG", 'Magic_2hrGlucose',
                                   ...
                                   'ln_HOMA-B', 'ln_HOMA-IR','ln_FastingInsulin', 'MAGIC_fastingProinsulin',
                                   'MAGIC_Scott_FI', 'MAGIC_HbA1C', 'Manning_FG',
                                   'Manning_BMI_ADJ_FG','Manning_Fasting_Insulin', 'Manning_BMI_ADJ_FI', 'HBA1C_ISI']  #
# Select_Top_Traits_Gen_arr_names = ['HbA1c_MANTRA', 't2d_mega_meta', "MAGIC_Scott_FG", 'Magic_2hrGlucose',
