...
TRAIN_PATH= '/net/mraid08/export/jafar/UKBioBank/Data/ukb29741_train_test.csv'
TEST_PATH = '/net/mraid08/export/jafar/UKBioBank/Data/ukb29741_val.csv'

ALL_TEST_AS_VAL = True
BASIC_JOB_NAME = ["Base_Genetics_Age45_and_Sex"]
BASIC_PROB_BASED_JOB_NAME = ["Re" + x for x in BASIC_JOB_NAME]
Sub_Class_array = ["All"]  # "All",, "All"
Job_ID = ["2443-0.0"]
RET_FEAT_file_names = ["Age_and_Sex"]

feat_list_folder = "Diabetes_Features_lists/For_article/"  # Folder where the features lists located
FEAT_file_names = ["Age_and_Sex"]  # Diabetes_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
...
CHARAC_SELECTED = {"Age at last visit": 45, "Sex": "All", "Ethnic background": "All",
