...
BASIC_JOB_NAME = "Age_Sex_Diab_PRS"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME+"_No_Prob"

FEAT_PATH = ["Age_n_Sex.csv"]  #"Age_n_Sex.csv",Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
Job_ID = ["2443-0.0"]  #
