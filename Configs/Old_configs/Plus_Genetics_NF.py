...
TRAIN_PATH = '/net/mraid08/export/jafar/UKBioBank/Data/ukb29741_Diabetes_returned_extended_Imputed_ROUND_train.csv'
TEST_PATH = '/net/mraid08/export/jafar/UKBioBank/Data/ukb29741_Diabetes_returned_extended_Imputed_ROUND_test.csv'

ALL_TEST_AS_VAL = True
BASIC_JOB_NAME = ["Plus_Genetics"]
BASIC_PROB_BASED_JOB_NAME = ["NF_" + x for x in BASIC_JOB_NAME]
Sub_Class_array = ["All"]  # "All",, "All"
Job_ID = ["2443-0.0"]
RET_FEAT_file_names = ["P_Diagnosis"]

feat_list_folder = "Diabetes_Features_lists/For_article/Additive/"  # Folder where the features lists located
...
PRS_COLS = ['PRS_MAGIC_HbA1C', 'PRS_MAGIC_Scott_FG', 'PRS_ln_HOMA-IR', 'PRS_MAGIC_Scott_FI',
            'PRS_Manning_FI', 'PRS_Leptin_BMI', 'PRS_Manning_FG', 'PRS_Non_Diabetic_glucose2',
            'PRS_MAGIC_fastingProinsulin','PRS_MAGIC_Scott_FI_adjBMI', 'PRS_MAGIC_Scott_2hGlu',
            'PRS_glucose_iris', 'PRS_ln_FastingInsulin','PRS_hba1c', 'PRS_ln_HOMA-B','PRS_diabetes_BMI_Unadjusted',
            'PRS_HbA1c_MANTRA','PRS_diabetes_BMI_Adjusted', 'PRS_Manning_BMI_ADJ_FI', 'PRS_FastingGlucose']
...
Select_Top_Traits_Gen_arr_names = ['HbA1c_MANTRA', 't2d_mega_meta', "MAGIC_Scott_FG", 'Magic_2hrGlucose',
                                   'diabetes_BMI_Unadjusted','diabetes_BMI_Adjusted', 'FastingGlucose',
                                   'ln_FastingInsulin', 'MAGIC_fastingProinsulin','MAGIC_Scott_FI',
                                   'MAGIC_HbA1C', 'Manning_FG','Manning_BMI_ADJ_FG',
                                   'Manning_Fasting_Insulin', 'Manning_BMI_ADJ_FI', 'HBA1C_ISI']
USE_FAKE_QUE = False
