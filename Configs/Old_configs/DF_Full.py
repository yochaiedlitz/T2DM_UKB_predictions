...
BASIC_JOB_NAME = ["DF_FULL_ExFeat"]
BASIC_PROB_BASED_JOB_NAME = ["RE_"+x+"_NRF" for x in BASIC_JOB_NAME]

FEAT_PATH = ["Diabetes_Features_0705.csv"]  #Diabetes_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
RET_FEAT_PATH=["Diabetes_Features_Returned_0705.csv"]
Job_ID = ["2443-0.0"]  #
