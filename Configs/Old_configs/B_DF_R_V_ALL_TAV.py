...
BASIC_JOB_NAME = "B_DF_HTAV2"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME+"_No_prob_20"
...
Hyp_Param_Dict_A['metric'] = ["binary_logloss"]  #MAP, aliases: mean_average_precision,kldiv, Kullback-Leibler divergence, aliases: kullback_leibler
Hyp_Param_Dict_A['num_boost_round'] = [1000, 2000, 4000, 8000, 16000]
Hyp_Param_Dict_A['verbose'] = [-1]
Hyp_Param_Dict_A['learning_rate'] = [0.01, 0.05,0.1, 0.5]
...
Hyp_Param_Dict_R['metric'] = ["binary_logloss"]  #MAP, aliases: mean_average_precision,kldiv, Kullback-Leibler divergence, aliases: kullback_leibler
