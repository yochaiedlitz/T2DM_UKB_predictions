...
BASIC_JOB_NAME = ["Vasc_RF"]
BASIC_PROB_BASED_JOB_NAME = ["RE_"+x+"_RF" for x in BASIC_JOB_NAME]

FEAT_PATH = ["Vasc_Features_1605.csv"]  #Diabetes_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
RET_FEAT_PATH=["Re_Vasc_Features_1605.csv"]
Job_ID = ["6150-0.0"]  #
  # Data_Job_Names = {"6150-0.0": "Vascular", "2443-0.0": "Diabetes", "2453-0.0": "Cancer", "4041-0.0": "Gestational diabetes","21001-0.0":'BMI'}
Sub_Class_array = [1,2,3,4]  # "All",, "All"
#"Coding	Meaning
# 1	Heart attack
# 2	Angina
# 3	Stroke
...
RE_USE_PROBA = False
Calc_Transfer_Learning=True #Used when we would like torefit several base models and not a specific model
#Refit_Return_Model_Path - path to model to be refitted in the first visit
REFIT_SERIAL_MODELS=True# #Checking wether to refit a model folder just made in previous step, or use a pedefined folder
...
SORT_Prob=True #Should be false only if results were already sorted and the PDF prep failed, or the user want to reprint
...
Hyp_Param_Dict_A['num_leaves']=[4,8,16,32,64,128]
...
Hyp_Param_Dict_A['num_boost_round'] = [10,50,100,250,500,1000, 2000]#,1000, 2000, 4000, 8000
Hyp_Param_Dict_A['learning_rate'] = [0.005, 0.01, 0.05,0.1]
Hyp_Param_Dict_A["min_child_samples"] = [10,25,50]
...
Hyp_Param_Dict_R['num_boost_round'] = [100,250,500]#,,1000, 2000, 4000, 8000
