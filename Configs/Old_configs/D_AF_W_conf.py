#Calculating model with water consumption and other questions that might be confounded, altough should not impact future visits
BASIC_JOB_NAME = "D_AF_H2O"
...
FEAT_PATH = ["Diabetes_Features_Plus_Water.csv"]  #Canc_Features.csv, Vasc_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
