...
BASIC_JOB_NAME = "B_DF_ATAV_auc"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME+"_prob_left"
BASIC_DATA_PATH='/net/mraid08/export/jafar/Microbiome/Analyses/Biobank/Comparison/Diabetes/BF_Diabetes/Diabetes_Base/'
PROBA_FOLDER = "/net/mraid08/export/jafar/Microbiome/Analyses/Biobank/Proba/BDF_AUC_AT/B_DF_ATAV_auc/"
...
FEAT_PATH = ["Full_Baseline_Features.csv"]  #Full_Baseline_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
...
Hyp_Param_Dict_A['num_boost_round'] = [1000, 2000, 4000]
...
Hyp_Param_Dict_A['lambda_l1'] = [0]
Hyp_Param_Dict_A['lambda_l2'] = [0]
...
Hyp_Param_Dict_R['num_boost_round'] = [1000,2000,4000]
