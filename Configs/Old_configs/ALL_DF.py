...
BASIC_JOB_NAME = ["No_Gluc_No_a1c_3105"]
...
FEAT_PATH = ["Diabetes_Features_0705"]  #Diabetes_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
RET_FEAT_PATH=["No_Gluc_No_a1c_3105"] #Features File name without ending
