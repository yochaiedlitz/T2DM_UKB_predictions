BASIC_JOB_NAME = "B_DF"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME+"_Prob_Only_Diab"
...
PROBA_FOLDER = "/net/mraid08/export/jafar/Microbiome/Analyses/Biobank/Proba/Proba_Base_Returned/"
