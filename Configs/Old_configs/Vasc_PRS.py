...
BASIC_JOB_NAME = "Vasc_AF_PRS"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME+"_Use_Prob"

FEAT_PATH = ["Vasc_Features.csv"]  #Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
Job_ID = ["6150-0.0"]  #
...
Hyp_Param_Dict_A['num_boost_round'] = [500,1000, 2000, 4000, 8000]#
