...
BASIC_JOB_NAME = ["Heart_attack","Angina","Stroke","High_Blood_Pressure"]
BASIC_PROB_BASED_JOB_NAME = ["RE_"+x+"_NRF_" for x in BASIC_JOB_NAME]

FEAT_PATH = ["Vasc_Features_1605.csv","Vasc_Features_1605.csv","Vasc_Features_1605.csv","Vasc_Features_1605.csv"]  #Diabetes_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
RET_FEAT_PATH=["Re_Vasc_Features_1605.csv","Re_Vasc_Features_1605.csv","Re_Vasc_Features_1605.csv","Re_Vasc_Features_1605.csv"]
Job_ID = ["6150-0.0","6150-0.0","6150-0.0","6150-0.0"]  #
...
# Select_Top_Traits_Gen_arr_names =['cardio']#
...
No_symp_dict = {"6150-0.0": [1,2,3], "2443-0.0": [0], '2453-0.0': [0], '21001-0.0': ["nan"]}
