...
BASIC_JOB_NAME = "Rft_BL_2_AF_Genes_20970"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME

FEAT_PATH = ["Diabetes_Features.csv"]  #Diabetes_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
Job_ID = ["2443-0.0"]  #
...
Select_Top_Traits_Gen_arr_names = ['HbA1c_MANTRA','t2d_mega_meta',"MAGIC_Scott_FG","triglycerides",'Magic_2hrGlucose','Manning_Fasting_Insulin']
...
USE_PRS = True #wether to use PRS reults
Refit_Model ='/net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/Basic_BL_D_Diabetes/Diabetes_Results/Diabetes_shap_model.txt'#  /net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/Refit/Refit_BL2AF_Diabetes/Diabetes_Results/Diabetes_shap_model.txt' #None# '/net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/Refit/Refit_BL2AF_Diabetes/Diabetes_Results/Diabetes_shap_model.txt'#Name of the model to be refitted or None
Refit_Return_Model_Path='/net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/RE_Basic_BL_D_No_Prob_Diabetes/Diabetes_Results/'#None#
NFOLD = 5
...
Hyp_Param_Dict_A['num_boost_round'] = [250,100,250,500,1000, 2000, 4000]#
...
Hyp_Param_Dict_A["colsample_bytree"] = [0.05, 0.1, 0.25, 0.5, 0.7, 1]
Hyp_Param_Dict_A["boost_from_average"] = [True]
Hyp_Param_Dict_A['num_threads'] = [N_THREADS]
Hyp_Param_Dict_A['lambda_l1'] = [0,0.5,0.9,0.99]
Hyp_Param_Dict_A['lambda_l2'] = [0,0.5,0.9,0.99]
...
Hyp_Param_Dict_R['num_boost_round'] = [100,250,500,1000, 2000, 4000]#,1000, 2000, 4000, 8000
...
Hyp_Param_Dict_R["colsample_bytree"] = [0.05, 0.1, 0.25, 0.5, 0.7, 1]
Hyp_Param_Dict_R["boost_from_average"] = [True]
Hyp_Param_Dict_R['num_threads'] = [N_THREADS]
Hyp_Param_Dict_R['lambda_l1'] = [0,0.5, 0.9, 0.99]
Hyp_Param_Dict_R['lambda_l2'] = [0,0.5, 0.9, 0.99]
