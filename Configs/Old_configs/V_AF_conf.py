...
FEAT_PATH = ["Vasc_Lifestyle.csv"]  #Age_n_Sex.csv,Canc_Features.csv, Vasc_Features.csv,Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv


BASIC_DATA_PATH='/net/mraid08/export/jafar/Microbiome/Analyses/Biobank/'
