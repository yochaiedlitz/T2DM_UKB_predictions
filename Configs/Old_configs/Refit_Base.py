...
BASIC_JOB_NAME = "Rft_bl2AF_Genes"
...
RET_FEAT_PATH=["Diabetes_Features_Returned.csv"]
Job_ID = ["2443-0.0"]  #
...
Refit_Model ='/net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/Basic_BL_D_Diabetes/Diabetes_Results/Diabetes_shap_model.txt' #None# '/net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/Refit/Refit_BL2AF_Diabetes/Diabetes_Results/Diabetes_shap_model.txt'#Name of the model to be refitted or None
