...
BASIC_JOB_NAME = ["Gluc_31_05","a1c_gluc_3105","AnS_a1c_G_BMI_Waist_3105"]
...
RET_FEAT_PATH=["Gluc_3105","a1c_gluc_3105","AnS_a1c_G_BMI_Waist_3105"] #Features File name without ending
Sub_Class_array = ["All","All","All"]  # "All",, "All"
Job_ID = ["2443-0.0","2443-0.0","2443-0.0"]  #

FEAT_PATH = [feat_list_folder+x+".csv" for x in FEAT_PATH]
RET_FEAT_PATH=[feat_list_folder+x+".csv" for x in RET_FEAT_PATH]
...
Select_Top_Traits_Gen_arr_names=[]
