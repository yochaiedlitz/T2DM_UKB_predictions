...
BASIC_JOB_NAME = "dbg_Diab_refit"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME+"_W_Prob"
...
Refit_Base_Model_file = '/net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/Basic_BL_D_Diabetes/Diabetes_Results/5_lgbm.txt' #"/net/mraid08/export/genie/Data/Yochai/UKBB_Runs/Basic_BL_D_Diabetes/Diabetes_Results/5_lgbm.txt" #Name of the model to be refitted or None
Refit_Return_Model_Path = '/net/mraid08/export/jafar/UKBioBank/Yochai/UKBB_Runs/RE_Basic_BL_D_No_Prob_Diabetes/Diabetes_Results/'# '/net/mraid08/export/genie/Data/Yochai/UKBB_Runs/RE_Basic_BL_D_No_Prob_Diabetes/Diabetes_Results/'#Name of the model to be refitted or None

if Refit_Base_Model_file is not None:
    if not os.path.exists(Refit_Base_Model_file) :
        sys.exit(['lgbm Refit_Base_Model_Path does not exist :'+Refit_Base_Model_file])
if Refit_Return_Model_Path is not None:
    if not os.path.exists(Refit_Return_Model_Path):
        sys.exit(['lgbm Refit_Return_Model_Path does not exist :'+Refit_Return_Model_Path])
# Refit_Return_Model_Path = None #Name of the model to be refitted or None
...
Hyp_Param_Dict_A['num_boost_round'] = [250,500,1000, 2000, 4000]#
...
Hyp_Param_Dict_R['num_boost_round'] = [250, 500, 1000, 2000, 4000]#,1000, 2000, 4000, 8000
