...
BASIC_JOB_NAME = "Canc_AF_PRS"
BASIC_PROB_BASED_JOB_NAME = "RE_"+BASIC_JOB_NAME+"_USE_Prob"

FEAT_PATH = ["Canc_Features.csv"]  #Diabetes_Features_No_Baseline.csv,Baseline_Features.csv,Diabetes_Features_Lifestyle.csv,Diabetes_Features_No_Baseline.csv, Full_Diabetes_Features # "Diabetes_Features.csv","Diabetes_Features.csv","Diabetes_Features.csv",BMI_Features_Lifestyle.csv
Job_ID = ["2453-0.0"]  #
